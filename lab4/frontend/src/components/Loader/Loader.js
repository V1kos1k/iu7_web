...
const DEF_SIZE = 200; // Pixels height/width
...
export default class Loader extends Component {
  ...
  render() {
    ...
    return this.props.isLoading ? (
      <div style={styles} className="lock shim modal">
      <div style={styles} className="sw-loader__wrapper  sw-loader__wrapper--center">
